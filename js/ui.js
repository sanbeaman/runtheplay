...
$(window).resize(function () {
	$('.dialog').each(function () {
		$(this).css({ left: window.innerWidth - $(this).outerWidth()+ 'px', top: '75px' });
	});
	/*
...
$('#button-inspector').click(function ()  {
		showDialog('#dialog-inspector');
		$('#dialog-inspector input').val(app.activeFieldItem.getLabel());
});
	...
	$('#button-reset').click(app.callbacks.fiReset);
	$('#dialog-inspector button.button-ok').click(app.callbacks.fiChangeLabel);
